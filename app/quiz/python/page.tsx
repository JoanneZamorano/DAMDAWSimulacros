...
const questions: Question[] = [
  ...
  },
  {
    ...
    options: ['Módulos de la librería de Python', 'Módulos hechos con otro lenguaje de programación', 'Módulos creados por ti', 'Módulos con extensiones .py'],
    correctAnswer: 1,
  },
  {
    id: 20,
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-3xl">
          ...
          <div className="space-y-3">
            {question.options.map((option, index) => {
              ...
              if (isAnswered) {
                ...
                buttonClass += 'hover:bg-blue-500/10 hover:border-blue-500'
              }
        ...
        {isAnswered && (
          <Button onClick={handleNext} size="lg" className="w-full bg-blue-500 hover:bg-blue-600">
