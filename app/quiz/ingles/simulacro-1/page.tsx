...
export default function InglesSimulacro1Quiz() {
        ...
        <Card className="w-full max-w-lg p-8 bg-card border-border">
          ...
          <div className="text-center space-y-6">
            <h1 className="text-4xl font-bold">
              <span className="text-foreground">Ingles</span>
            </h1>
            ...
            <div className="space-y-4 text-left py-6">
              <div className="flex items-start gap-3">
                <Check className="w-5 h-5 text-rose-500 mt-0.5 shrink-0" />
                <div>
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-lg p-8 bg-card border-border">
          <div className="text-center space-y-6">
            ...
            <div className="py-8">
              <div className="text-6xl font-bold text-rose-500 mb-2">{Math.max(0, percentage)}%</div>
            ...
            <div className="space-y-2">
              {percentage >= 90 && <p className="text-lg text-foreground">Excelente. Dominas Ingles.</p>}
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="flex items-center justify-between p-4 border-b border-border">
        ...
        <div className="text-sm text-muted-foreground">
          ...
          <span className="text-rose-500">{answeredCount} respondidas</span>
        </div>
      </div>
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${!showFeedback && "hover:border-rose-500 hover:bg-accent cursor-pointer"}
                      ${showFeedback && "cursor-not-allowed"}
                      ${isSelected && !showFeedback && "border-rose-500 bg-accent"}
