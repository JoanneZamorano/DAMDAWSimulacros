...
const questions: Question[] = [
  ...
  },
  {
    ...
    options: ["Máxima redundancia.", "Mínima integridad.", "Máxima integridad y mínima redundancia.", "Máximo desorden."],
    correctAnswer: 2
  },
  {
    question: "¿Qué son las entidades, registros y atributos en una base de datos?",
    options: ["Tipos de datos.", "Componentes básicos de una base de datos.", "Lenguajes de consulta.", "Niveles de abstracción."],
    correctAnswer: 1
  },
  {
  ...
  },
  {
    ...
    options: ["Sistema de Gestión de Lenguajes.", "Lenguaje de Consulta Estructurado.", "Sistema Global de Localización.", "Lenguaje de Programación Orientado a Objetos."],
    correctAnswer: 1
  },
  {
    question: "¿Cuál es la función principal de un Sistema Gestor de Bases de Datos (SGBD)?",
    options: ["Almacenar archivos multimedia.", "Gestionar las tablas y sus relaciones.", "Diseñar interfaces de usuario.", "Crear aplicaciones web."],
    correctAnswer: 1
  },
  {
    question: "Explica la diferencia entre una base de datos jerárquica y una base de datos en red.",
    options: ["Ambas son iguales.", "La jerárquica tiene un padre y varios hijos, la de red varios padres y varios hijos.", "La jerárquica usa SQL, la de red NoSQL.", "La jerárquica es distribuida, la de red centralizada."],
    correctAnswer: 1
  },
  {
    question: "¿Qué ventajas ofrece una base de datos documental en comparación con una base de datos relacional?",
    options: ["Mayor integridad referencial.", "Estructura fija y predefinida.", "Flexibilidad y capacidad para manejar datos semiestructurados.", "Menor escalabilidad."],
    correctAnswer: 2
  },
  {
  ...
  },
  {
    ...
    options: ["Físico, lógico y de usuario.", "Conceptual, físico y de visión.", "DML, DDL y DCL.", "Centralizado, distribuido y en la nube."],
    correctAnswer: 0
  },
  {
    question: "¿Cuáles son las características clave de una base de datos descentralizada como Blockchain y qué ventajas ofrece?",
    options: ["Centralizada, rápida y económica.", "Inmutable, transparente y segura.", "Relacional, escalable y flexible.", "Jerárquica, redundante y compleja."],
    correctAnswer: 1
  },
  {
    question: "¿Cuál es el objetivo principal del Reglamento General de Protección de Datos (GDPR)?",
    options: ["Regular el uso de cookies.", "Proteger la privacidad del individuo.", "Fomentar el uso de Big Data.", "Establecer técnicas de análisis predictivo."],
    correctAnswer: 1
  },
  {
    question: "¿Qué derechos garantiza la Ley Orgánica de Protección de Datos Personales y garantía de los derechos digitales (LOPDGDD) a los usuarios?",
    options: ["Acceso, rectificación, supresión y oposición.", "Uso ilimitado de datos sensibles.", "Almacenamiento masivo de datos sin consentimiento.", "Análisis prescriptivo de datos personales."],
    correctAnswer: 0
  },
  {
    question: "¿Qué implicaciones tienen el GDPR y la LOPDGDD para los diseñadores y administradores de bases de datos?",
    options: ["Solo la implementación de seguridad física.", "Asesoramiento legal e implementación de seguridad.", "Exclusivamente la gestión de cookies.", "Ninguna, ya que son leyes para usuarios finales."],
    correctAnswer: 1
  },
  {
    question: "¿Qué características definen el concepto de Big Data?",
    options: ["Pequeño volumen de datos, variedad limitada y procesamiento lento.", "Gran volumen de datos, variedad de fuentes y velocidad de procesamiento.", "Datos estructurados y análisis descriptivo exclusivamente.", "Datos centralizados y control total del administrador."],
    correctAnswer: 1
  },
  {
    question: "Explica las diferencias entre las técnicas de análisis de datos predictivo, descriptivo y prescriptivo, y proporciona un ejemplo de aplicación para cada una.",
    options: ["Todas son iguales y se aplican indistintamente.", "Predictivo predice, descriptivo analiza el pasado, prescriptivo recomienda acciones.", "Descriptivo predice, prescriptivo describe, predictivo recomienda.", "Solo el análisis descriptivo es relevante para la toma de decisiones."],
    correctAnswer: 1
  },
  {
    question: "¿Cuál es la diferencia fundamental entre datos e información?",
    options: ["Los datos son siempre numéricos, la información es textual.", "La información tiene contexto y organización, los datos no.", "Los datos son más valiosos que la información.", "No hay diferencia, son términos intercambiables."],
    correctAnswer: 1
  },
  {
    question: "¿Qué funciones clave desempeña un Sistema Gestor de Bases de Datos (SGBD)?",
    options: ["Solo el almacenamiento de datos.", "Almacenamiento, acceso y actualización eficiente de datos.", "Únicamente la creación de informes.", "La gestión de redes informáticas."],
    correctAnswer: 1
  },
  {
    question: "¿Qué caracteriza a un fichero de acceso secuencial?",
    options: ["El acceso directo a cualquier registro.", "El uso de índices para acceder a los datos.", "La lectura de datos de manera consecutiva.", "El acceso mediante una fórmula matemática."],
    correctAnswer: 2
  },
  {
    question: "¿Cuáles son las tres \"V\" del Big Data?",
    options: ["Veracidad, valor y volumen.", "Variedad, velocidad y valor.", "Volumen, variedad y velocidad.", "Visualización, veracidad y volumen."],
    correctAnswer: 2
  },
  {
    question: "¿Qué objetivo principal tiene el Reglamento General de Protección de Datos (GDPR)?",
    options: ["Regular el uso de cookies.", "Proteger la privacidad y dar control a los individuos sobre sus datos personales.", "Fomentar el uso de Big Data.", "Establecer normas para la fragmentación de bases de datos."],
    correctAnswer: 1
  },
  {
    question: "¿Cuál es el objetivo principal de la fragmentación de bases de datos?",
    options: ["Reducir el tamaño total de la base de datos.", "Mejorar la seguridad de los datos.", "Escalar la base de datos y mejorar el rendimiento.", "Simplificar la administración de la base de datos."],
    correctAnswer: 2
  },
  {
    question: "¿En qué consiste la fragmentación basada en rangos?",
    options: ["Aplicar una función hash a una clave de fragmento.", "Dividir los datos en función de rangos de valores especificados.", "Especificar explícitamente qué fragmento almacenará ciertos datos.", "Almacenar todos los datos en un único servidor."],
    correctAnswer: 1
  },
  {
    question: "¿Cómo funciona la fragmentación basada en hash?",
    options: ["Dividiendo los datos por rangos de valores.", "Asignando datos a fragmentos basados en una lista predefinida.", "Aplicando una función hash a una clave de fragmento para determinar el fragmento.", "Distribuyendo los datos aleatoriamente entre los fragmentos."],
    correctAnswer: 2
  },
  {
    question: "¿Qué caracteriza a la fragmentación basada en listas?",
    options: ["Utiliza rangos de valores para distribuir los datos.", "Asigna datos a fragmentos mediante una función hash.", "Especifica qué fragmento almacena datos basados en una lista de valores.", "Divide la base de datos en fragmentos de igual tamaño."],
    correctAnswer: 2
  },
  {
    question: "¿Qué ventajas ofrece la fragmentación de bases de datos en términos de rendimiento?",
    options: ["Reduce la necesidad de copias de seguridad.", "Permite el procesamiento paralelo y reduce los cuellos de botella.", "Aumenta la complejidad de las consultas SQL.", "Simplifica la gestión de permisos de usuario."],
    correctAnswer: 1
  },
  {
  ...
  {
    question: "Caso 2: La Liga de Fútbol - Plataforma de Datos Deportivos en Tiempo Real. Selecciona el SGBD más adecuado.",
    options: [
  ...
  {
    question: "Caso 3: Censo de Ciudadanos - Sistema de Gestión de Datos Nacional (Hacienda). Selecciona el SGBD más adecuado.",
    options: [
  ...
  },
  {
    ...
    options: ["Sistema General de Base de Datos", "Sistema Gestor de Base de Datos", "Sistema de Gestión de Bases de Datos", "Sistema General de Gestión de Datos"],
    correctAnswer: 1
  },
  {
  ...
  },
  {
    ...
    options: ["Lenguaje de Control de Datos", "Lenguaje de Compilación de Datos", "Lenguaje de Coordinación de Datos", "Lenguaje de Construcción de Datos"],
    correctAnswer: 0
  },
  {
  ...
  },
  {
    ...
    options: ["Motor de Evaluación de Consultas", "Gestor de Seguridad", "Procesador de Consultas", "Interfaz de Usuario"],
    correctAnswer: 2
  },
  {
  ...
  {
    question: "¿Cuál es el propósito principal del Lenguaje de Definición de Datos (DDL) en un Sistema de Gestión de Bases de Datos (SGBD)?",
    options: [
  ...
  {
    question: "¿Qué componente de un SGBD es responsable de garantizar que las transacciones de la base de datos cumplan con las propiedades ACID?",
        ...
        <div className="max-w-3xl mx-auto">
          <Card className="p-8 bg-card border-border">
            <div className="text-center space-y-6">
              ...
              <div className="text-6xl font-bold text-blue-500">{percentage}%</div>
              <p className="text-xl text-muted-foreground">
                Has acertado {score} de {questions.length} preguntas
              </p>
              <div className="flex gap-4 justify-center flex-wrap">
                <Button onClick={resetQuiz} size="lg" className="bg-blue-500 hover:bg-blue-600">
                  Reintentar
                </Button>
                <Link href="/">
