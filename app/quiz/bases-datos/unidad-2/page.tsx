...
export default function Unidad2ModeloER() {
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          ...
          <div className="text-center flex-1">
            <h1 className="text-2xl md:text-2xl font-bold text-foreground">Bases de Datos - U2: Modelo E/R</h1>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm font-medium text-blue-600">Puntuación: {score}</span>
        </div>
