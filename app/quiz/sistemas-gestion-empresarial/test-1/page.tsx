...
const questions: Question[] = [
  { question: "¿Qué es un ERP?", options: ["Sistema de gestión empresarial", "Lenguaje programación", "Sistema operativo", "Base de datos"], correctAnswer: 0 },
  { question: "¿Qué integra un ERP?", options: ["Solo ventas", "Áreas empresariales", "Solo contabilidad", "Solo RRHH"], correctAnswer: 1 },
  { question: "¿Qué caracteriza a Odoo?", options: ["Código cerrado", "Solo local", "Modularidad", "Solo móvil"], correctAnswer: 2 },
  { question: "¿Qué es CRM?", options: ["Gestión servidores", "Gestión hardware", "Gestión red", "Gestión clientes"], correctAnswer: 3 },
  { question: "¿Qué permite la arquitectura SOA?", options: ["Flexibilidad modular", "Dependencia total", "Sin integración", "Sin datos"], correctAnswer: 0 },
  { question: "¿Qué base de datos usa Odoo?", options: ["MySQL", "PostgreSQL", "Oracle", "MongoDB"], correctAnswer: 1 },
  { question: "¿Qué hace el servidor Odoo?", options: ["Interfaz", "Almacén físico", "Lógica negocio", "UI"], correctAnswer: 2 },
  { question: "¿Qué es un módulo?", options: ["Usuario", "Archivo", "Servidor", "Servicio independiente"], correctAnswer: 3 },
  { question: "¿Qué permite Docker?", options: ["Virtualización ligera", "Instalar manual", "Eliminar datos", "Solo cloud"], correctAnswer: 0 },
  { question: "¿Qué ventaja tiene Docker?", options: ["Complejidad", "Rapidez despliegue", "Más errores", "Sin control"], correctAnswer: 1 },
  { question: "¿Qué es conciliación bancaria?", options: ["Eliminar datos", "Crear usuarios", "Comparar movimientos", "Borrar cuentas"], correctAnswer: 2 },
  { question: "¿Qué automatiza Odoo contable?", options: ["Emails", "Usuarios", "UI", "Asientos contables"], correctAnswer: 3 },
  { question: "¿Qué genera una factura?", options: ["Asiento contable", "Servidor", "Usuario", "Archivo"], correctAnswer: 0 },
  { question: "¿Qué es un lead?", options: ["Factura", "Cliente potencial", "Pedido", "Producto"], correctAnswer: 1 },
  { question: "¿Qué hace CRM?", options: ["Almacena código", "Gestiona ventas", "Gestiona clientes", "Gestiona red"], correctAnswer: 2 },
  { question: "¿Qué es Kanban?", options: ["Base datos", "Servidor", "API", "Vista visual"], correctAnswer: 3 },
  { question: "¿Qué ocurre al confirmar pedido?", options: ["Se factura", "Se borra", "Se ignora", "Se archiva"], correctAnswer: 0 },
  { question: "¿Qué mejora automatización?", options: ["Errores", "Eficiencia", "Coste", "Tiempo"], correctAnswer: 1 },
  { question: "¿Qué controla inventario?", options: ["Ventas", "Usuarios", "Stock", "API"], correctAnswer: 2 },
  { question: "¿Qué permite trazabilidad?", options: ["Eliminar datos", "Crear usuarios", "UI", "Seguir producto"], correctAnswer: 3 },
  { question: "¿Qué genera bajo stock?", options: ["Compra automática", "Venta", "Error", "Factura"], correctAnswer: 0 },
  { question: "¿Qué es auditoría inicial?", options: ["Configuración", "Diagnóstico", "Programación", "UI"], correctAnswer: 1 },
  { question: "¿Qué es parametrización?", options: ["Programar", "Eliminar datos", "Configurar sistema", "Diseñar UI"], correctAnswer: 2 },
  { question: "¿Qué es migración datos?", options: ["Eliminar info", "Crear usuarios", "UI", "Importar datos"], correctAnswer: 3 },
  { question: "¿Qué es Go-Live?", options: ["Inicio sistema", "Fin sistema", "Error", "Backup"], correctAnswer: 0 },
  { question: "¿Qué permite Odoo Studio?", options: ["Programar", "Personalizar sin código", "Eliminar datos", "Servidor"], correctAnswer: 1 },
  { question: "¿Qué es vista formulario?", options: ["Lista", "Gráfico", "Detalle registro", "Calendario"], correctAnswer: 2 },
  { question: "¿Qué es vista lista?", options: ["Detalle", "Gráfico", "Calendario", "Tabla registros"], correctAnswer: 3 },
  { question: "¿Qué es vista Kanban?", options: ["Etapas", "Tabla", "Texto", "Código"], correctAnswer: 0 },
  { question: "¿Qué es vista calendario?", options: ["Texto", "Eventos fecha", "Código", "API"], correctAnswer: 1 }
];
