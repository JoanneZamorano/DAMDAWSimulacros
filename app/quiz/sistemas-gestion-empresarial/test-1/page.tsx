...
const questions: Question[] = [
  { question: "1.¿Qué es un ERP?", options: ["Sistema de gestión empresarial", "Lenguaje programación", "Sistema operativo", "Base de datos"], correctAnswer: 0 },
  { question: "2.¿Qué integra un ERP?", options: ["Solo ventas", "Áreas empresariales", "Solo contabilidad", "Solo RRHH"], correctAnswer: 1 },
  { question: "3.¿Qué caracteriza a Odoo?", options: ["Código cerrado", "Solo local", "Modularidad", "Solo móvil"], correctAnswer: 2 },
  { question: "4.¿Qué es CRM?", options: ["Gestión servidores", "Gestión hardware", "Gestión red", "Gestión clientes"], correctAnswer: 3 },
  { question: "5.¿Qué permite la arquitectura SOA?", options: ["Flexibilidad modular", "Dependencia total", "Sin integración", "Sin datos"], correctAnswer: 0 },
  { question: "6.¿Qué base de datos usa Odoo?", options: ["MySQL", "PostgreSQL", "Oracle", "MongoDB"], correctAnswer: 1 },
  { question: "7.¿Qué hace el servidor Odoo?", options: ["Interfaz", "Almacén físico", "Lógica negocio", "UI"], correctAnswer: 2 },
  { question: "8.¿Qué es un módulo?", options: ["Usuario", "Archivo", "Servidor", "Servicio independiente"], correctAnswer: 3 },
  { question: "9.¿Qué permite Docker?", options: ["Virtualización ligera", "Instalar manual", "Eliminar datos", "Solo cloud"], correctAnswer: 0 },
  { question: "10.¿Qué ventaja tiene Docker?", options: ["Complejidad", "Rapidez despliegue", "Más errores", "Sin control"], correctAnswer: 1 },
  { question: "11.¿Qué es conciliación bancaria?", options: ["Eliminar datos", "Crear usuarios", "Comparar movimientos", "Borrar cuentas"], correctAnswer: 2 },
  { question: "12.¿Qué automatiza Odoo contable?", options: ["Emails", "Usuarios", "UI", "Asientos contables"], correctAnswer: 3 },
  { question: "13.¿Qué genera una factura?", options: ["Asiento contable", "Servidor", "Usuario", "Archivo"], correctAnswer: 0 },
  { question: "14.¿Qué es un lead?", options: ["Factura", "Cliente potencial", "Pedido", "Producto"], correctAnswer: 1 },
  { question: "15.¿Qué hace CRM?", options: ["Almacena código", "Gestiona ventas", "Gestiona clientes", "Gestiona red"], correctAnswer: 2 },
  { question: "16.¿Qué es Kanban?", options: ["Base datos", "Servidor", "API", "Vista visual"], correctAnswer: 3 },
  { question: "17.¿Qué ocurre al confirmar pedido?", options: ["Se factura", "Se borra", "Se ignora", "Se archiva"], correctAnswer: 0 },
  { question: "18.¿Qué mejora automatización?", options: ["Errores", "Eficiencia", "Coste", "Tiempo"], correctAnswer: 1 },
  { question: "19.¿Qué controla inventario?", options: ["Ventas", "Usuarios", "Stock", "API"], correctAnswer: 2 },
  { question: "20.¿Qué permite trazabilidad?", options: ["Eliminar datos", "Crear usuarios", "UI", "Seguir producto"], correctAnswer: 3 },
  { question: "21.¿Qué genera bajo stock?", options: ["Compra automática", "Venta", "Error", "Factura"], correctAnswer: 0 },
  { question: "22.¿Qué es auditoría inicial?", options: ["Configuración", "Diagnóstico", "Programación", "UI"], correctAnswer: 1 },
  { question: "23.¿Qué es parametrización?", options: ["Programar", "Eliminar datos", "Configurar sistema", "Diseñar UI"], correctAnswer: 2 },
  { question: "24.¿Qué es migración datos?", options: ["Eliminar info", "Crear usuarios", "UI", "Importar datos"], correctAnswer: 3 },
  { question: "25.¿Qué es Go-Live?", options: ["Inicio sistema", "Fin sistema", "Error", "Backup"], correctAnswer: 0 },
  { question: "26.¿Qué permite Odoo Studio?", options: ["Programar", "Personalizar sin código", "Eliminar datos", "Servidor"], correctAnswer: 1 },
  { question: "27.¿Qué es vista formulario?", options: ["Lista", "Gráfico", "Detalle registro", "Calendario"], correctAnswer: 2 },
  { question: "28.¿Qué es vista lista?", options: ["Detalle", "Gráfico", "Calendario", "Tabla registros"], correctAnswer: 3 },
  { question: "29.¿Qué es vista Kanban?", options: ["Etapas", "Tabla", "Texto", "Código"], correctAnswer: 0 },
  { question: "30.¿Qué es vista calendario?", options: ["Texto", "Eventos fecha", "Código", "API"], correctAnswer: 1 }
];
...
export default function SGETest1Quiz() {
