...
const questions: Question[] = [
  ...
  {
    question: "4. ¿Cuál es el punto de partida en la metodología de implantación de un ERP?",
  ...
  {
    question: "5. ¿Qué actividades se desarrollan durante el análisis funcional en una implantación ERP?",
  ...
  {
    question: "6. ¿Qué proceso empresarial se ejecuta durante la fase de migración en una implantación ERP?",
  ...
  {
    question: "7. ¿Cuál es el propósito principal de la fase de Go-Live en la implementación de un ERP?",
  ...
  {
    question: "8. En Odoo, ¿cuál es la naturaleza técnica de un modelo?",
  ...
  {
    question: "9. ¿Cuál es la función principal del ORM (Object-Relational Mapping) en Odoo?",
  ...
  {
    question: "10. En Odoo, ¿qué tipo de campo relacional vincula varios registros de un modelo con un único registro de otro modelo (por ejemplo, varias facturas con un mismo cliente)?",
    options: ["Many2one", "Text", "Float", "Selection"],
    correctAnswer: 0,
  },
  {
    question: "11. ¿Qué representa una vista en la arquitectura de Odoo?",
  ...
  {
    question: "12. ¿Qué capacidad proporciona la funcionalidad de filtros en Odoo?",
  ...
  {
    question: "13. ¿Cuál es el resultado de aplicar la función Group By sobre un conjunto de registros?",
  ...
  {
    question: "14. ¿Qué utilidad tienen los favoritos en las búsquedas de Odoo?",
  ...
  {
    question: "15. ¿Cuál es la característica principal de la vista de Lista en Odoo?",
  ...
  {
    question: "16. ¿Para qué tipo de procesos es más adecuada la vista Kanban en Odoo?",
  ...
  {
    question: "17. ¿Qué ventaja principal ofrece Odoo Studio en el desarrollo empresarial?",
  ...
  {
    question: "18. ¿Cuál es el impacto positivo de automatizar los procesos contables en un ERP?",
  ...
  {
    question: "19. ¿Qué proceso automático se desencadena al validar una factura de venta en Odoo?",
  ...
  {
    question: "20. ¿Cuál es el objetivo principal de la conciliación bancaria en un ERP?",
  ...
  {
    question: "21. ¿Cuál es la principal ventaja empresarial de integrar módulos ERP y CRM en una única plataforma?",
  ...
  {
    question: "22. ¿Qué es la arquitectura SOA (Service-Oriented Architecture) en el contexto de sistemas ERP modernos?",
  ...
  {
    question: "23. ¿Qué componente ejecuta la lógica de negocio en un ERP como Odoo?",
    options: ["El servidor web y la base de datos conjuntamente", "El servidor de aplicacion o backend, que contiene toda la lógica empresarial", "Exclusivamente el navegador del cliente mediante JavaScript", "El protocolo HTTP de comunicación entre cliente y servidor"],
    correctAnswer: 1,
  },
  {
    question: "24. ¿Cuál es la función principal del cliente en un ERP como Odoo?",
  ...
  {
    question: "25. ¿Qué ventaja proporciona el uso de una base de datos centralizada en un ERP?",
  ...
  {
    question: "26. ¿Qué permite la interoperabilidad en un sistema ERP moderno?",
  ...
  {
    question: "27. ¿Qué se realiza durante el análisis funcional en la implantación de un ERP?",
  ...
  {
    question: "28. ¿Qué significa parametrizar un sistema ERP?",
  ...
  {
    question: "29. ¿Qué fase de implantación de un ERP implica importar y validar datos históricos del sistema anterior?",
  ...
  {
    question: "30. ¿Cuál es un riesgo importante que debe gestionarse cuidadosamente durante la migración de datos a un ERP?",
  ...
  {
    question: "31. ¿Cuál es el propósito principal de un sistema CRM dentro de una estrategia empresarial?",
