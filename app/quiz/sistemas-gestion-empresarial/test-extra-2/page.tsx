...
const questions: Question[] = [
{
  ...
  {
    question: "91.Un CRM empresarial tiene como objetivo principal optimizar la relación con clientes. ¿Cuál de las siguientes actividades es responsabilidad directa de un sistema CRM?",
  ...
  {
    question: "92. La modularidad es una característica clave en la arquitectura de los ERP modernos ¿Qué ventaja operativa proporciona la modularidad?",
  ...
  {
    question: "93. Odoo es una plataforma ERP de código abierto ampliamente utilizada ¿Cuál es la base de datos que utiliza Odoo de forma nativa y recomendada?",
    options: ["Microsoft SQL Server", "Oracle Database", "PostgreSQL", "MongoDB"],
    correctAnswer: 2,
  },
  {
    question: "94. La arquitectura SOA (Arquitectura Orientada a Servicios) es un patrón arquitectónico importante en sistemas empresariales modernos. ¿Cuál es el principio fundamental de una arquitectura SOA?",
  ...
  {
    question: "97. Una base de datos centralizada en un ERP aporta múltiples ventajas operativas. ¿Cuál es la ventaja más significativa de mantener una única base de datos centralizada para toda la empresa?",
  ...
  {
    question: "98. La interoperabilidad es una característica importante en sistemas ERP modernos ¿Qué permite la interoperabilidad en un ERP?",
  ...
  {
    question: "99. La implantación de un ERP es un proceso estructurado que requiere múltiples fases. ¿Cuál es la fase inicial más crítica en una implantación de ERP?",
  ...
  {
    question: "100. El análisis funcional es una etapa clave en la implantación de un ERP ¿Qué se realiza específicamente durante el análisis funcional?",
  ...
  {
    question: "101. Parametrizar un ERP es una actividad fundamental durante su implantación ¿Qué significa parametrizar un sistema ERP?",
