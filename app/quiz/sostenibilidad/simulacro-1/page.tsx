...
const questions: Question[] = [
  {
    question: "Pregunta de ejemplo 1 para Sostenibilidad",
    options: ["Opcion A", "Opcion B", "Opcion C", "Opcion D"],
    correctAnswer: 0,
  },
  {
    question: "Pregunta de ejemplo 2 para Sostenibilidad",
    options: ["Opcion A", "Opcion B", "Opcion C", "Opcion D"],
    correctAnswer: 1,
  },
]
...
export default function SostenibilidadSimulacro1Quiz() {
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-lg p-8 bg-card border-border">
          <div className="text-center space-y-6">
            ...
            <div className="py-8">
              <div className="text-6xl font-bold text-lime-500 mb-2">{Math.max(0, percentage)}%</div>
            ...
            <div className="space-y-2">
              {percentage >= 90 && <p className="text-lg text-foreground">Excelente. Dominas Sostenibilidad.</p>}
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="flex items-center justify-between p-4 border-b border-border">
        ...
        <div className="text-sm text-muted-foreground">
          ...
          <span className="text-lime-500">{answeredCount} respondidas</span>
        </div>
      </div>
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${!showFeedback && "hover:border-lime-500 hover:bg-accent cursor-pointer"}
                      ${showFeedback && "cursor-not-allowed"}
                      ${isSelected && !showFeedback && "border-lime-500 bg-accent"}
