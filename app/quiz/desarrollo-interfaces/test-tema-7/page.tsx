...
const questions: Question[] = [
  {
    "question": "¿Qué es el reporting?",
    "options": ["Mostrar datos", "Convertir datos en documentos", "Guardar datos", "Optimizar código"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué herramienta destaca en Java?",
    "options": ["Hibernate", "JasperReports", "Spring", "Docker"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué es un archivo JRXML?",
    "options": ["Código Java", "Plantilla de informe", "Base de datos", "Script"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué separa JasperReports?",
    "options": ["Código y datos", "Diseño y datos", "UI y backend", "SQL y Java"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué define la plantilla?",
    "options": ["Datos", "Estructura visual", "Código", "Eventos"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué es DataSource?",
    "options": ["UI", "Fuente de datos", "CSS", "Controlador"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué hace el motor Jasper?",
    "options": ["Compilar Java", "Combinar datos y plantilla", "Guardar datos", "Optimizar SQL"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué es .jasper?",
    "options": ["Archivo XML", "Archivo compilado", "Base de datos", "Script"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué permiten las bandas?",
    "options": ["Control de eventos", "Estructurar informe", "Diseñar UI", "Gestionar red"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué banda se repite por registro?",
    "options": ["Title", "Header", "Detail", "Footer"],
    "correctAnswer": 2
  },
  {
    "question": "¿Qué formato se puede exportar?",
    "options": ["PDF", "Excel", "HTML", "Todos"],
    "correctAnswer": 3
  },
  {
    "question": "¿Qué problema evita Jasper?",
    "options": ["Errores visuales", "Código", "Memoria", "CPU"],
    "correctAnswer": 0
  },
  {
    "question": "¿Qué contiene una factura?",
    "options": ["Datos estáticos y dinámicos", "Solo texto", "Solo imágenes", "Solo código"],
    "correctAnswer": 0
  },
  {
    "question": "¿Qué hace el backend?",
    "options": ["Diseña UI", "Llama a Jasper", "Gestiona CSS", "Optimiza CPU"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué permite el DataSource?",
    "options": ["Filtrar datos", "Diseñar UI", "Crear código", "Optimizar red"],
    "correctAnswer": 0
  },
  {
    "question": "¿Qué herramienta visual se usa?",
    "options": ["Figma", "Jaspersoft Studio", "Photoshop", "Excel"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué permite JavaBeans?",
    "options": ["Separar datos", "Diseñar UI", "Crear CSS", "Optimizar CPU"],
    "correctAnswer": 0
  },
  {
    "question": "¿Qué permiten los parámetros?",
    "options": ["Filtrar informes", "Crear UI", "Optimizar memoria", "Eliminar datos"],
    "correctAnswer": 0
  },
  {
    "question": "¿Qué mito es falso?",
    "options": ["Jasper es útil", "Jasper está obsoleto", "Jasper es potente", "Jasper se usa"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué ventaja clave aporta?",
    "options": ["Automatización", "Errores", "Complejidad", "Latencia"],
    "correctAnswer": 0
  }
]
