...
const questions: Question[] = [
  ...
  {
    question: "63. ¿Qué concepto de la ISO 9241 define la capacidad de un producto para ser utilizado por usuarios específicos a fin de alcanzar objetivos determinados con efectividad, eficiencia y satisfacción?",
    options: ["Usabilidad", "Accesibilidad", "Compatibilidad", "Rendimiento"],
    correctAnswer: 0,
  },
  {
    question: "64. ¿Qué patrón de diseño de interfaces reduce la carga cognitiva mostrando únicamente la información relevante en cada momento de la interacción?",
  ...
  {
    question: "65. En JavaFX, ¿qué técnica permite crear un control personalizado extendiéndolo de Region o Control para usarlo en múltiples pantallas sin duplicar código?",
  ...
  {
    question: "66. ¿Qué mecanismo es más adecuado para persistir las preferencias de interfaz de una aplicación JavaFX entre diferentes sesiones de usuario?",
  ...
  {
    question: "67. ¿Cuál es la herramienta oficial y visual que proporciona Oracle en JavaFX para diseñar interfaces visuales de manera gráfica (WYSIWYG)?",
    options: ["Scene Builder", "NetBeans Designer", "Eclipse Visual Editor", "IntelliJ UI Designer"],
    correctAnswer: 0,
  },
  {
    question: "68. Según la norma ISO 9241, ¿qué atributo de usabilidad (conocido en inglés como *learnability*) mide la facilidad con que un usuario nuevo aprende a utilizar una interfaz sin entrenamiento previo?",
    options: ["Capacidad de aprendizaje", "Accesibilidad", "Consistencia", "Eficiencia"],
    correctAnswer: 0,
  },
  {
    question: "69. ¿Cuál es la clase base de la cual heredan la mayoría de controles visuales en JavaFX?",
    options: ["Control", "Node", "Region", "Parent"],
    correctAnswer: 0,
  },
  {
    question: "70. ¿Qué patrón de diseño se implementa cuando se utiliza un archivo FXML junto con una clase controladora?",
    options: ["Model-View-Controller", "Singleton", "Factory", "Observer"],
    correctAnswer: 0,
  },
  {
    question: "71. ¿Cuál es la principal ventaja de utilizar propiedades vinculables (binding properties) en JavaFX?",
  ...
  {
    question: "72. ¿Cuál de los siguientes NO es un aspecto considerado en la definición ISO 9241-11 de usabilidad?",
  ...
  {
    question: "73. ¿Cuál es el propósito principal de utilizar un enfoque visual WYSIWYG en el diseño de interfaces?",
  ...
  {
    question: "74. ¿Cuál es la tecnología de referencia para desarrollar interfaces gráficas de escritorio en Java?",
    options: ["Swing", "JavaFX", "AWT", "Android UI"],
    correctAnswer: 1,
  },
  {
    question: "75. ¿Qué lenguaje de marcado utiliza JavaFX para definir interfaces de usuario de forma declarativa?",
    options: ["HTML", "XML", "FXML", "JSON"],
    correctAnswer: 2,
  },
  {
    question: "76. ¿Cuál es la clase base de la que heredan todos los controles en JavaFX?",
    options: ["Node", "Control", "Component", "Widget"],
    correctAnswer: 1,
  },
  {
    question: "77. En el contexto de desarrollo de interfaces, ¿qué concepto se refiere a la facilidad con la que un usuario puede interactuar y utilizar una aplicación?",
    options: ["Accesibilidad", "Usabilidad", "Rendimiento", "Escalabilidad"],
    correctAnswer: 1,
  },
  {
    question: "78. En JavaFX, ¿qué técnica permite encapsular un fragmento de interfaz gráfica con su lógica asociada para usarlo en múltiples pantallas sin duplicar código?",
  ...
  {
    question: "80. ¿Qué estrategia de diseño de interfaces reduce la carga cognitiva del usuario?",
  ...
  {
    question: "81. ¿Cuál es el estructura general de un archivo FXML en JavaFX?",
  ...
  {
    question: "82. ¿Cuál de las siguientes afirmaciones sobre diseño de interfaces de usuario es CORRECTA (no un mito)?",
  ...
  {
    question: "83. ¿Qué lenguaje de programación utiliza el framework Flutter para el desarrollo de interfaces móviles?",
    options: ["Kotlin", "Dart", "Java", "Swift"],
    correctAnswer: 1,
  },
  {
    question: "84. ¿Cuál es el propósito principal del atributo fx:id en las definiciones FXML?",
  ...
  {
    question: "85. ¿En dónde se almacenan típicamente los archivos de definición de layouts en el desarrollo de aplicaciones Android?",
    options: ["En la carpeta /src", "En la carpeta /res/layout", "En la carpeta /app/java", "En la carpeta /drawable"],
    correctAnswer: 1,
  },
  {
    question: "86. ¿Cuál es la principal ventaja de separar el diseño de la interfaz de la lógica de aplicación?",
  ...
  {
    question: "87. En diseño de interfaces, ¿qué principio busca específicamente reducir la carga cognitiva mostrando solo la información necesaria en cada momento?",
  ...
  {
    question: "88. ¿Cuál es la clase raíz de la que hereda cualquier elemento de la jerarquía de escena (scene graph) en JavaFX, incluyendo controles, layouts y formas gráficas?",
    options: ["Component", "Node", "Control", "Widget"],
    correctAnswer: 1,
  },
  {
    question: "89. ¿Qué característica del paradigma WYSIWYG facilita el proceso de desarrollo de interfaces?",
  ...
  {
    question: "90. ¿Qué mecanismo de JavaFX permite incluir y reutilizar archivos FXML dentro de otros archivos FXML para construir interfaces modulares?",
  ...
  {
    question: "91. ¿Cuál es el principal beneficio de desacoplar la apariencia de un componente de su funcionalidad?",
  ...
  {
    question: "92. Según la norma ISO 9241, ¿cuál es la definición de usabilidad?",
  ...
  {
    question: "93. ¿Qué aspecto NO forma parte de la evaluación de usabilidad de una interfaz?",
  ...
  {
    question: "94. En una arquitectura de capas, ¿cuál es la responsabilidad principal de la capa de persistencia?",
