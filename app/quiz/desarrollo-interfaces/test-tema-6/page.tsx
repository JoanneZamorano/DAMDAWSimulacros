...
const questions: Question[] = [
  {
    "question": "¿Qué permite que una interfaz sea visualmente comprensible?",
    "options": ["Decoración", "Organización visual de la información", "Uso de colores", "Animaciones"],
    "correctAnswer": 1
  },
  {
    "question": "¿Cuál es el objetivo de la simplicidad?",
    "options": ["Añadir elementos", "Reducir carga cognitiva", "Usar más colores", "Aumentar opciones"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué ley se relaciona con la simplicidad?",
    "options": ["Ley de Ohm", "Ley de Hick", "Ley de Newton", "Ley de Moore"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué ocurre si hay demasiados elementos?",
    "options": ["Mejora UX", "Aumenta velocidad", "Aumenta confusión", "Reduce carga"],
    "correctAnswer": 2
  },
  {
    "question": "¿Qué es la consistencia?",
    "options": ["Uso de colores", "Repetición de patrones", "Uso de animaciones", "Uso de código"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué ocurre sin consistencia?",
    "options": ["Mejora UX", "El usuario reaprende", "Aumenta claridad", "Reduce errores"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué usan empresas como Google?",
    "options": ["Bases de datos", "Design systems", "Frameworks", "APIs"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué es jerarquía visual?",
    "options": ["Tamaño de texto", "Organizar información", "Color", "Código"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué guía la jerarquía?",
    "options": ["Código", "Usuario", "Servidor", "Red"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué elementos usa la jerarquía?",
    "options": ["CPU", "Color, tamaño y espacio", "RAM", "API"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué caracteriza Google Search?",
    "options": ["Complejidad", "Simplicidad", "Animaciones", "Colores"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué hay en la home de Google?",
    "options": ["Muchos elementos", "Solo búsqueda", "Publicidad", "Noticias"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué reduce la simplicidad?",
    "options": ["Velocidad", "Carga cognitiva", "Memoria", "Código"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué mejora la consistencia?",
    "options": ["Errores", "Aprendizaje", "Latencia", "CPU"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué herramienta usa grid 8pt?",
    "options": ["SQL", "Design systems", "CSS", "Java"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué permite el espacio en blanco?",
    "options": ["Reducir claridad", "Mejorar jerarquía", "Aumentar ruido", "Reducir UX"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué es un wireframe?",
    "options": ["Código", "Diseño final", "Estructura básica", "Animación"],
    "correctAnswer": 2
  },
  {
    "question": "¿Qué es un prototipo?",
    "options": ["Código", "Simulación interactiva", "Base de datos", "API"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué herramienta destaca en UX?",
    "options": ["MySQL", "Figma", "Docker", "Linux"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué demuestra Airbnb?",
    "options": ["Prototipar es inútil", "Prototipar reduce riesgo", "Código es mejor", "UX no importa"],
    "correctAnswer": 1
  }
]
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-lg p-8 bg-card border-border">
          ...
          <div className="text-center space-y-6">
            ...
            <h2 className="text-xl text-muted-foreground">Test tema 6</h2>
