...
const questions: Question[] = [
  {
    "question": "¿Qué aporta la documentación al software?",
    "options": ["Solo diseño", "Comunicación", "Velocidad", "Memoria"],
    "correctAnswer": 1
  },
  {
    "question": "¿Para quién es la documentación de usuario?",
  ...
  {
    "question": "¿Qué es ayuda contextual?",
    "options": ["Manual externo", "Ayuda integrada", "API", "Código"],
    "correctAnswer": 1
  },
  {
    "question": "¿Cuándo aparece la ayuda contextual?",
    "options": ["Siempre", "Nunca", "Justo a tiempo", "Al inicio"],
    "correctAnswer": 2
  },
  {
    "question": "¿Qué reduce?",
  ...
  {
    "question": "¿Qué es documentación API?",
    "options": ["Manual", "Guía usuario", "Doc técnica", "CSS"],
    "correctAnswer": 2
  },
  {
  ...
  {
    "question": "¿Qué herramientas API se usan?",
    "options": ["Git", "Javadoc/Swagger", "Docker", "SQL"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué explica la documentación?",
    "options": ["Cómo y por qué", "Solo cómo", "Solo qué", "Nada"],
    "correctAnswer": 0
  },
  {
    "question": "¿Qué demuestra Stripe?",
    "options": ["Código", "UX", "Doc como producto", "UI"],
    "correctAnswer": 2
  },
  {
    "question": "¿Qué incluye un README?",
    "options": ["Solo código", "Instalación y uso", "CSS", "API"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué es jpackage?",
    "options": ["IDE", "Herramienta Java", "DB", "Framework"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué genera jpackage?",
    "options": ["Código", "Instaladores", "CSS", "APIs"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué es empaquetado?",
    "options": ["Diseño", "Preparar instalación", "Código", "Debug"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué hace la firma digital?",
    "options": ["Optimiza", "Garantiza autenticidad", "Diseña", "Compila"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué usan Windows/macOS?",
    "options": ["Firewall", "SmartScreen/Gatekeeper", "API", "DB"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué es canal de distribución?",
    "options": ["Código", "Entrega software", "UI", "API"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué ventaja tienen App Stores?",
    "options": ["CPU", "Instalación y updates", "Memoria", "Código"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué mito es falso?",
    "options": ["JAR suficiente", "Firma necesaria", "Doc importante", "Instaladores útiles"],
    "correctAnswer": 0
  }
]
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-lg p-8 bg-card border-border">
          ...
          <div className="text-center space-y-6">
            ...
            <h2 className="text-xl text-muted-foreground">Test tema 8</h2>
