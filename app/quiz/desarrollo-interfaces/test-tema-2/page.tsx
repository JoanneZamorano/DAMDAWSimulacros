...
const questions: Question[] = [
  {
    "question": "¿Qué problema tiene crear interfaces “a pelo”?",
    "options": ["Más velocidad", "Mayor control sin inconvenientes", "Mucha fricción", "Menos errores"],
    "correctAnswer": 2
  },
  {
    "question": "¿Qué permiten los editores visuales?",
    "options": ["Eliminar código", "Maquetar arrastrando y soltando", "Programar backend", "Optimizar CPU"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué archivo genera JavaFX?",
    "options": ["HTML", "FXML", "JSON", "CSS"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué archivo usa Android?",
    "options": ["FXML", "XML", "JSON", "YAML"],
    "correctAnswer": 1
  },
  {
  ...
  {
    "question": "¿Qué contenedor es de JavaFX?",
    "options": ["ConstraintLayout", "VBox", "RecyclerView", "Fragment"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué contenedor es de Android?",
    "options": ["VBox", "HBox", "ConstraintLayout", "GridPane"],
    "correctAnswer": 2
  },
  {
    "question": "¿Qué representa el árbol de nodos?",
    "options": ["Código", "Jerarquía de componentes", "Errores", "Eventos"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué permite el drag&drop?",
    "options": ["Más errores", "Construcción rápida", "Menos control", "Menos claridad"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué es fx:id?",
    "options": ["Un error", "Un estilo", "Identificador", "Un evento"],
    "correctAnswer": 2
  },
  {
  ...
  {
    "question": "¿Qué acelera el prototipado?",
    "options": ["Código manual", "Editores visuales", "Backend", "Debug"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué democratizan los editores?",
    "options": ["Backend", "Trabajo visual", "Redes", "Seguridad"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué herramienta usa JavaFX?",
    "options": ["Scene Builder", "Photoshop", "Blender", "Excel"],
    "correctAnswer": 0
  },
  {
    "question": "¿Qué Layout usa Android?",
    "options": ["VBox", "ConstraintLayout", "HBox", "GridPane"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué es WYSIWYG?",
    "options": ["Código limpio", "Editor visual", "Framework", "Lenguaje"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué mejora usar IDs?",
    "options": ["Estética", "Conectar código", "Velocidad CPU", "Memoria"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué mito es falso?",
    "options": ["Editores generan código limpio", "Editores generan código sucio", "Mejoran productividad", "Separan lógica"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué se usa para eventos?",
    "options": ["CSS", "Controlador", "FXML", "XML"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué no sustituyen los editores?",
    "options": ["Programación", "Diseño", "Frontend", "UX"],
    "correctAnswer": 0
  }
]
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-lg p-8 bg-card border-border">
          ...
          <div className="text-center space-y-6">
            ...
            <h2 className="text-xl text-muted-foreground">Test tema 2</h2>
