...
const questions: Question[] = [
  ...
  {
    "question": "¿Cuál es el objetivo principal de una GUI?",
    "options": ["Ser estética", "Reducir costes", "Hacer tareas comprensibles y ejecutables", "Aumentar código"],
    "correctAnswer": 2
  },
  {
    "question": "¿Qué elemento NO forma parte de una GUI?",
    "options": ["Botones", "Menús", "Cuadros de texto", "Algoritmos de ordenación"],
    "correctAnswer": 3
  },
  {
    "question": "¿Qué mejora una GUI bien diseñada?",
    "options": ["Errores", "Tiempo de aprendizaje", "Complejidad", "Latencia"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué pilar define qué espera el usuario?",
    "options": ["Rendimiento", "Modelo mental", "Consistencia", "Backend"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué pilar implica patrones repetidos?",
    "options": ["Modelo mental", "Consistencia", "Datos", "UI"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué pilar se refiere a respuesta rápida?",
    "options": ["Feedback", "Modelo", "Consistencia", "Backend"],
    "correctAnswer": 0
  },
  {
    "question": "¿Qué tecnología es para escritorio Java?",
    "options": ["Flutter", "React Native", "JavaFX", ".NET MAUI"],
    "correctAnswer": 2
  },
  {
    "question": "¿Qué tecnología usa C#?",
    "options": ["JavaFX", ".NET MAUI", "Flutter", "React"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué tecnología usa Dart?",
    "options": ["Flutter", "JavaFX", ".NET", "React"],
    "correctAnswer": 0
  },
  {
    "question": "¿Qué tecnología usa JS/TS?",
    "options": ["Flutter", "React Native", "JavaFX", "MAUI"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué elemento traduce gestos en eventos?",
    "options": ["Usuario", "GUI", "DB", "Backend"],
    "correctAnswer": 1
  },
  {
    "question": "¿Dónde está la lógica de negocio?",
    "options": ["GUI", "Usuario", "BL", "CSS"],
    "correctAnswer": 2
  },
  {
    "question": "¿Qué gestiona persistencia?",
    "options": ["GUI", "Usuario", "Datos/Servicios", "Eventos"],
    "correctAnswer": 2
  },
  {
    "question": "¿Qué empresa popularizó el caso de estudio?",
    "options": ["Microsoft", "Slack", "Google", "Apple"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué reduce la carga cognitiva?",
    "options": ["Colores", "Jerarquía visual", "Código", "Backend"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué herramienta se usa con JavaFX?",
    "options": ["Eclipse", "Scene Builder", "Photoshop", "Figma"],
    "correctAnswer": 1
  },
  {
    "question": "¿Qué separa vista de lógica?",
    "options": ["MVC", "HTML", "CSS", "SQL"],
    "correctAnswer": 0
  },
  {
    "question": "¿Qué es un mito?",
    "options": ["La GUI importa", "La GUI es el producto", "La GUI es solo estética", "UX influye"],
    "correctAnswer": 2
  },
  {
    "question": "¿Qué habilidad es clave?",
    "options": ["Aprender un framework", "Memorizar código", "Adaptabilidad", "Solo backend"],
    "correctAnswer": 2
  }
]
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-lg p-8 bg-card border-border">
          ...
          <div className="text-center space-y-6">
            ...
            <h2 className="text-xl text-muted-foreground">Test tema 1</h2>
