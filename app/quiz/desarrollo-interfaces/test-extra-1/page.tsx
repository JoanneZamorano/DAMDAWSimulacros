...
const questions: Question[] = [
  {
    question: "1. ¿Qué capa de la arquitectura es responsable de gestionar la persistencia de datos en una aplicación?",
    options: ["Presentación (GUI)", "Lógica de negocio (Usuario)", "Capa de datos y servicios", "Sistema de eventos"],
    correctAnswer: 2,
  },
  {
    question: "2. ¿Qué herramienta oficial proporciona Oracle para diseñar interfaces visuales en JavaFX?",
    options: ["Blender", "Scene Builder", "Photoshop", "Excel"],
    correctAnswer: 1,
  },
  {
    question: "3. ¿Qué principio de diseño se representa mediante el acrónimo WYSIWYG?",
  ...
  {
    question: "4. ¿Cuál de las siguientes afirmaciones sobre los editores visuales modernos (como Scene Builder) es INCORRECTA?",
  ...
  {
    question: "5. ¿Qué aspecto de la interfaz define el lenguaje FXML en una aplicación JavaFX?",
  ...
  {
    question: "8. ¿Cuál es una ventaja principal de reutilizar componentes en desarrollo de interfaces?",
  ...
  {
    question: "11. ¿Qué característica de una interfaz favorece que el usuario comprenda su estructura y funcionalidad visualmente?",
  ...
  {
    question: "12. El principal objetivo de aplicar simplicidad en el diseño de una interfaz es:",
  ...
  {
    question: "13. ¿Cuál es la consecuencia principal de sobrecargar una interfaz con demasiados elementos visuales?",
  ...
  {
    question: "14 ¿Cuál es la herramienta estándar más utilizada en ecosistema Java para generación de reportes profesionales?",
    options: ["Maven", "JasperReports", "Gradle", "Jenkins"],
    correctAnswer: 1,
  },
  {
    question: "15. ¿Qué tipo de archivo representa una plantilla de informe en sistemas de reportes Java?",
  ...
  {
    question: "16. ¿Cuál es el aporte primordial de la documentación en un proyecto de software?",
  ...
  {
    question: "17. ¿A quién está dirigida principalmente la documentación de usuario en una aplicación software?",
  ...
  {
    question: "18. ¿Cuál de los siguientes elementos NO forma parte de los componentes típicos de una interfaz gráfica de usuario (GUI)?",
  ...
  {
    question: "19. ¿Qué framework recomienda Oracle actualmente para desarrollar interfaces gráficas modernas en aplicaciones Java de escritorio?",
    options: ["Swing", "JavaFX", "Flutter", "React Native"],
    correctAnswer: 1,
  },
  {
    question: "20. ¿Qué lenguaje de programación es base del framework .NET MAUI?",
    options: ["Java", "Dart", "C#", "JavaScript"],
    correctAnswer: 2,
  },
  {
    question: "21. ¿Qué lenguaje de tipado estático está asociado al framework Flutter?",
    options: ["Python", "Dart", "Go", "Rust"],
    correctAnswer: 1,
  },
  {
    question: "22. ¿Cuál es la principal funcionalidad de los editores visuales en el desarrollo de interfaces?",
  ...
  {
    question: "23. En Android, ¿en qué formato se guardan los archivos de layout ubicados en la carpeta res/layout/ para definir la interfaz de usuario?",
  ...
  {
    question: "24. ¿Qué beneficio principal se obtiene al mantener la lógica de negocio separada del código de presentación?",
  ...
  {
    question: "25. ¿Cuál es el propósito del componente FXMLLoader dentro del ecosistema JavaFx?",
  ...
  {
    question: "26. ¿Qué representa la estructura jerárquica de elementos en un documento XML de interfaz?",
  ...
  {
    question: "27. En una aplicación similar a Netflix, ¿qué aspecto de la interfaz describe un documento XML?",
  ...
  {
    question: "28. ¿Qué contenido se empaqueta dentro de un archivo JAR en una aplicación Java?",
  ...
  {
    question: "29. ¿Qué herramientas se utilizan habitualmente para gestionar las dependencias externas en proyectos Java?",
    options: ["Docker y Kubernetes", "Maven y Gradle", "Git y GitHub", "Apache Hadoop"],
    correctAnswer: 1,
  },
  {
    question: "30. ¿Cuál es una de las funcionalidades clave que proporciona Maven en el ciclo de vida del desarrollo?",
  ...
  {
    question: "31. ¿Qué ventajas proporciona el uso de librerías internas personalizadas en un proyecto de desarrollo de interfaces?",
  ...
  {
    question: "32. ¿Cuál es el propósito principal de mantener la visibilidad del estado en una interfaz?",
  ...
  {
    question: "33. ¿Qué se entiende por correspondencia con el mundo real en el diseño de interfaces?",
  ...
  {
    question: "34. ¿Qué principio de diseño permite que el usuario corrija sus acciones sin consecuencias permanentes?",
  ...
  {
    question: "35. ¿Cómo se define la consistencia en el contexto del desarrollo de interfaces?",
  ...
  {
    question: "36. ¿Cuál es la consecuencia para la experiencia del usuario cuando falta consistencia en el diseño?",
  ...
  {
    question: "37. ¿Cuál es la función principal de un design system en empresas tecnológicas modernas?",
  ...
  {
    question: "38. ¿Qué aspecto fundamental separa JasperReports en su arquitectura?",
  ...
  {
    question: "39. En un sistema de reporting como JasperReports, ¿qué componente actúa como contenedor principal que organiza bandas, campos y elementos visuales definiendo el layout completo del informe?",
  ...
  {
    question: "40. ¿De dónde obtiene principalmente un informe dinámico sus fuentes de datos?",
  ...
  {
    question: "41. ¿Qué características debe poseer la documentación dirigida a usuarios finales?",
  ...
  {
    question: "42. ¿Cuál es el propósito de implementar ayuda contextual integrada en una aplicación?",
  ...
  {
    question: "43. ¿Qué se consigue mediante la implementación de documentación integral en una aplicación?",
  ...
  {
    question: "44. ¿Qué tipo de información debe incluir la documentación técnica de una API?",
  ...
  {
    question: "45. En JavaFX, ¿qué formato de archivo específico permite definir interfaces de usuario de forma declarativa y es compatible con herramientas como Scene Builder?",
    options: ["FXML (.fxml)", "JSX (.jsx)", "XAML (.xaml)", "XHTML (.xhtml)"],
    correctAnswer: 0,
  },
  {
    question: "46. ¿Qué atributo en FXML se utiliza para identificar de manera única un nodo y permitir su referencia desde el código controlador?",
