...
const questions: Question[] = [
  ...
  {
    question: "5. ¿A qué tres atributos fundamentales se refiere la tríada CIA en el contexto de ciberseguridad?",
    options: [
  ...
  {
    question: "6. ¿Cuál de las siguientes proposiciones describe adecuadamente el potencial técnico de Blockchain en entornos empresariales?",
    options: [
  ...
  {
    question: "7. ¿Cómo se define técnicamente un Gemelo Digital en el contexto de manufactura inteligente?",
    options: [
  ...
  {
    question: "8. En la solución Vision Picking de DHL, ¿cuál es la función específica que desempeña la Realidad Aumentada en la operación de picking?",
    options: [
  ...
  {
    question: "9. ¿Qué característica técnica del 5G lo posiciona como infraestructura crítica para desplegar aplicaciones de IoT industrial y Gemelos Digitales a escala masiva?",
    options: [
  ...
  {
    question: "10. Una empresa requiere plataforma virtualizada donde instalar su propio sistema operativo, aplicaciones custom y gestionar completamente el software de negocio. ¿Qué modelo de servicio cloud se ajusta a esta necesidad?",
    options: [
  ...
  {
    question: "11. Una empresa almacena datos críticos financieros en servidores de propiedad propia dentro de su data center, y simultaneamente usa infraestructura de Amazon Web Services para gestionar picos de tráfico en su portal de e-commerce. ¿Cuál es el modelo de nube que implementa?",
    options: [
  ...
  {
    question: "12. ¿Cuál es el propósito funcional de plataformas internas como Gravity en grandes instituciones financieras?",
    options: [
  ...
  {
    question: "13. ¿Cuál es la relación jerárquica entre Machine Learning, Deep Learning y redes neuronales?",
    options: [
  ...
  {
    question: "14. ¿Qué capacidades técnicas de procesamiento de lenguaje permiten que sistemas de IA empresariales ejecuten análisis de sentimiento en medios sociales y mantengan diálogos contextualmente coherentes?",
    options: [
  ...
  {
    question: "15. ¿Qué marco regulatorio europeo establece requisitos de trazabilidad, supervisión humana y clasificación de riesgos para sistemas de IA?",
    options: [
  ...
  {
    question: "16. ¿Qué combinación de técnicas utiliza Spotify en su función Discover Weekly para generar listas de reproducción personalizadas cada semana?",
    options: [
  ...
  {
    question: "17. ¿Cuál es la diferencia fundamental entre un dato bruto y la información derivada de él?",
    options: [
  ...
  {
    question: "18. ¿Por qué el ataque WannaCry de 2017 afectó masivamente a organizaciones globales en tan poco tiempo?",
    options: [
  ...
  {
    question: "19. ¿Qué conjunto de derechos fundamentales reconoce el RGPD a los ciudadanos europeos sobre sus datos personales?",
    options: [
  ...
  {
    question: "20. ¿Qué revolución industrial se caracterizó por la introducción de la energía eléctrica y la mecanización de la producción en cadena?",
    options: [
  ...
  {
    question: "21. ¿Cuál es el factor clave que permite a la planta Siemens Amberg mantener la misma área y plantilla mientras multiplica significativamente la producción a lo largo de tres décadas?",
    options: [
  ...
  {
    question: "22. Un técnico de agricultura de precisión necesita obtener mapas de índice NDVI y estrés hídrico de 200 hectáreas de cereal en una sola jornada. ¿Qué tecnología es la más adecuada?",
    options: [
  ...
  {
    question: "23. ¿Qué enfoque empresarial en moda permite diseñar y producir colecciones en ciclos muy cortos, respondiendo en tiempo real a la demanda mediante integración digital de toda la cadena de valor?",
    options: [
  ...
  {
    question: "24. ¿Cuál es la característica fundamental que diferencia un dispositivo IoT de un electrodoméstico electrónico tradicional?",
    options: [
  ...
  {
    question: "25. ¿Cuál es el impacto principal de los robots colaborativos en entornos logísticos como el de DHL?",
    options: [
  ...
  {
    question: "26. ¿Qué clase de ciberataque se produce cuando un adversario inunda deliberadamente un servidor con tráfico masivo para impedir su funcionamiento y bloquear el acceso a usuarios legítimos?",
    options: [
  ...
  {
    question: "27. ¿Qué ventaja ambiental fundamental proporciona la fabricación aditiva en comparación con los métodos sustractivos tradicionales?",
    options: [
  ...
  {
    question: "28. ¿Para qué propósito específico implementa McLaren la tecnología Blockchain en sus operaciones de Fórmula 1?",
    options: [
  ...
  {
    question: "29. ¿Cuál de las siguientes analogías describe mejor el modelo IaaS en computación en nube?",
    options: [
  ...
  {
    question: "30. ¿Qué servicio de infraestructura en nube utiliza Netflix para acercar contenido audiovisual a usuarios finales en diferentes regiones geográficas, reduciendo latencia y mejorando la experiencia?",
    options: [
  ...
  {
    question: "31. ¿Cuál es el estándar internacional de ciberseguridad que especifica requisitos obligatorios para el procesamiento seguro de datos de tarjetas de crédito y débito?",
    options: [
  ...
  {
    question: "32. ¿Qué componente esencial del aprendizaje automático permite que un modelo de IA mejore su precisión progresivamente?",
    options: [
  ...
  {
    question: "33. ¿Qué plataforma de Google permite entrenar modelos de clasificación de objetos mediante interfaz visual sin código?",
    options: [
  ...
  {
    question: "34. ¿Qué lección crítica demostró el caso del sistema de selección de personal desechado por Amazon?",
    options: [
  ...
  {
    question: "35. En el contexto del Big Data, ¿cuál de las tres V se refiere a la multiplicidad de formatos y procedencias de los datos?",
    options: [
  ...
  {
    question: "36. En un sistema de gestión de datos empresarial con procesamiento por lotes (batch), ¿cuál es la secuencia estándar del ciclo de vida del dato según las buenas prácticas de arquitectura de datos?",
    options: [
  ...
  {
    question: "37. ¿Qué arquitectura de datos combina la estructura y gobernanza de un Data Warehouse con la escalabilidad y flexibilidad de un Data Lake?",
    options: [
  ...
  {
    question: "38. En la infraestructura de datos de Airbnb, ¿qué rol cumple Amazon S3 diferenciado de Amazon Redshift?",
    options: [
  ...
  {
    question: "39. ¿Qué principio del RGPD establece que la seguridad de datos debe integrarse desde las fases iniciales del diseño de sistemas?",
    options: [
  ...
  {
    question: "40. ¿Qué herramienta analítica permite clasificar proyectos de digitalización en dos dimensiones para identificar cuáles ofrecen mayor retorno relativo al coste de implementación?",
    options: [
  ...
  {
    question: "41. ¿Cuál fue el posicionamiento estratégico elegido por BBVA en su transformación digital empresarial?",
    options: [
  ...
  {
    question: "42. ¿Qué metodología ágil utiliza tableros visuales con columnas para monitorizar el flujo de trabajo y detectar puntos de congestión?",
    options: [
  ...
  {
    question: "43. ¿Qué herramienta de análisis competitivo clasifica a proveedores de software en cuatro cuadrantes: líderes, visionarios, jugadores de nicho y retadores?",
    options: [
  ...
  {
    question: "44. ¿Qué modelo de servicio cloud permite que una empresa mantenga control total sobre la infraestructura mientras externaliza la gestión de actualizaciones y parches?",
    options: [
