...
const questions: Question[] = [
  ...
  },
  {
    ...
    options: ["Un entorno gráfico", "Un compilador de proyectos web", "Un programa que elimina errores", "Una herramienta que gestiona librerías y versiones del software"],
    correctAnswer: 3
  },
  {
  ...
  },
  {
    ...
    options: ["Cuando dos ramas modifican la misma parte del archivo", "Cuando se cancela un push", "Cuando se mezclan dos ramas sin diferencias y los commit avanzan sin problema", "Cuando no hay commits e intentas hacer git commit"],
    correctAnswer: 0
  },
  {
  ...
  },
  {
    ...
    options: ["Validar código fuente en bruto", "Verificar el correcto funcionamiento de componentes aislados", "Probar todo el sistema completo", "Verificar que todas las operaciones de input/output funcionan correctamente"],
    correctAnswer: 1
  },
  {
  ...
  },
  {
    ...
    options: ["Ocupan menos memoria", "No requieren precompilación", "No necesitan entorno de ejecución", "Se ejecutan más rápido"],
    correctAnswer: 1
  },
  {
    question: "¿Qué es un lenguaje de programación?",
    options: ["Una máquina que ejecuta programas", "Un medio para escribir algoritmos que una máquina puede interpretar", "Un conjunto de herramientas de depuración", "Un tipo de compilador"],
    correctAnswer: 1
  },
  {
  ...
  },
  {
    ...
    options: ["Para tener trabajo para los alumnos de ciclos que van de prácticas a la empresa", "Para ralentizar el desarrollo pero mejorar el rendimiento", "Para facilitar mantenimiento y comprensión", "Para que el software se vea bonito"],
    correctAnswer: 2
  },
  {
    question: "¿Cuál es la diferencia entre git reset y git revert?",
    options: ["Reset elimina el archivo; revert renombra", "Reset cambia ramas; revert borra ramas", "Reset modifica el historial; revert crea un commit inverso", "No la hay, ambos comandos realizan la misma operación, pero reset es más moderno"],
    correctAnswer: 2
  },
  {
  ...
  {
    question: "¿Qué es Git?",
    options: ["Una plataforma que permite hospedar repositorios en la nube", "Un gestor de dependencias", "Un sistema operativo en la nube", "Un sistema de control de versiones"],
    correctAnswer: 3
  },
  {
  ...
  },
  {
    ...
    options: ["Reduce errores de compilación", "Hace que el programa se ejecute más rápido", "Facilita la comprensión por parte de otros desarrolladores", "Hace que se necesiten menos pruebas"],
    correctAnswer: 2
  },
  {
    question: "¿Qué caracteriza a las metodologías ágiles?",
    options: ["Enfoque exclusivamente técnico", "Desarrollo en cascada", "Documentación extensiva", "Iteraciones cortas y entregas frecuentes"],
    correctAnswer: 3
  },
  {
  ...
  },
  {
    ...
    options: ["Un lenguaje de programación", "Un lenguaje de marcado ligero", "Una librería de Java", "Un depurador que se usa en Python"],
    correctAnswer: 1
  },
  {
  ...
  },
  {
    ...
    options: ["Un entorno para programar con herramientas integradas", "Un sistema operativo", "Un depurador de errores", "Un compilador"],
    correctAnswer: 0
  },
  {
    question: "¿Qué herramienta se suele incluir en un IDE?",
    options: ["Reproductor multimedia", "Editor de código, compilador, debugger", "Analizador de virus", "Planificador de tareas escolares"],
    correctAnswer: 1
  },
  {
    question: "¿Cuál de estas acciones realiza `git clone`?",
    options: ["Descarga un repositorio remoto", "Crea un conflicto", "Sube un archivo", "Clona el historial de commits de un repositorio a otro"],
    correctAnswer: 0
  },
  {
  ...
  },
  {
    ...
    options: ["Para eliminar repositorios", "Para renombrar archivos", "Para crear o listar ramas", "Para mezclar cambios"],
    correctAnswer: 2
  },
  {
  ...
  },
  {
    ...
    options: ["Automatizar instalaciones", "Escribir documentación", "Localizar y corregir errores en el código", "Traducir código"],
    correctAnswer: 2
  },
  {
  ...
  },
  {
    ...
    options: ["Crear una máquina virtual", "Usar Javadoc", "Tener permisos de colaborador o hacer pull request", "Necesitar ser propietario de Git para poder así colaborar en Github"],
    correctAnswer: 2
  },
  {
    question: "¿Qué hace git rebase?",
    options: ["Borra commits antiguos", "Reinicia el repositorio", "Fusiona ramas de forma lineal", "Crea ramas automáticamente"],
    correctAnswer: 2
  },
  {
  ...
  },
  {
    ...
    options: ["Para ver el historial de commits de forma dinámica", "Para modificar conflictos", "Para guardar cambios sin hacer commit", "Para eliminar ramas"],
    correctAnswer: 2
  }
]
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-2xl p-8 bg-card border-border">
          <div className="text-center space-y-6">
            ...
            {percentage >= 80 && (
              <p className="text-lg text-green-500">Excelente trabajo</p>
            )}
            {percentage >= 60 && percentage < 80 && (
              <p className="text-lg text-blue-500">Buen resultado, sigue practicando</p>
            )}
            {percentage < 60 && (
              <p className="text-lg text-orange-500">Necesitas repasar más</p>
            )}
    ...
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-4xl mx-auto py-8">
        ...
        <Card className="p-6 bg-card border-border">
          <h2 className="text-xl font-semibold mb-6 text-foreground whitespace-pre-line">
            {question.question}
          </h2>
